Pod::Spec.new do |s|  
    s.name              = "SciChart"
    s.version           = "2.1.0.08e937c4dd660386875a455ceed298799291ab07"
    ...
    s.platform          = :ios
    s.source            = { :http => "https://github.com/ABTSoftware/PodSpecs/releases/download/v2.1.0.08e937c4dd660386875a455ceed298799291ab07/SciChart_iOS_Framework.zip" }
